...
$model | ConvertTo-Json | Set-Content "~/Desktop\$YYYYMMDD-MaintenanceLogs\MaintenanceReportData.json"
$hostname = Get-WmiObject Win32_ComputerSystem | Select-Object Name
$hostname | ConvertTo-Json | Add-Content "~/Desktop\$YYYYMMDD-MaintenanceLogs\MaintenanceReportData.json"
$serial = Get-WmiObject Win32_bios | Select-Object SerialNumber
$serial | ConvertTo-Json | Add-Content "~/Desktop\$YYYYMMDD-MaintenanceLogs\MaintenanceReportData.json"
$os = (Get-WmiObject -class Win32_OperatingSystem).Caption
$os | ConvertTo-Json | Add-Content "~/Desktop\$YYYYMMDD-MaintenanceLogs\MaintenanceReportData.json"
