...
$os | ConvertTo-Json | Add-Content ".\$YYYYMMDD-Logs\MaintenanceReportData.json"
$ram = (Get-CimInstance Win32_PhysicalMemory | Measure-Object -Property capacity -Sum).sum /1gb
$ram | ConvertTo-Json | Add-Content ".\$YYYYMMDD-Logs\MaintenanceReportData.json"
...
$drivespace | ConvertTo-Json | Add-Content ".\$YYYYMMDD-Logs\MaintenanceReportData.json"